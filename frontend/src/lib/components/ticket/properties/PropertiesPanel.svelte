...
{#if active}
	<details class="group rounded-lg border border-indigo-200 dark:border-indigo-800 bg-indigo-50/30 dark:bg-indigo-900/20" open>
		<summary class="flex cursor-pointer items-center justify-between p-3 text-sm font-semibold text-indigo-800 dark:text-indigo-300">
		...
		<div class="border-t border-indigo-100 dark:border-indigo-800 p-3">
			{#if active.type === 'text'}
