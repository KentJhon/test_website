...
<svelte:head>
	<title>Veent - Ticket Generator & Event Tools</title>
</svelte:head>

<!-- Hero Section -->
<section class="relative overflow-hidden bg-slate-900 text-white">
	<!-- Background decorations -->
	<div class="absolute inset-0 bg-gradient-to-br from-indigo-600/20 via-transparent to-purple-600/10"></div>
	<div class="absolute top-0 left-1/2 h-[500px] w-[800px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-indigo-600/10 blur-3xl"></div>
	<div class="absolute bottom-0 right-0 h-[300px] w-[400px] translate-x-1/4 translate-y-1/4 rounded-full bg-purple-600/10 blur-3xl"></div>
	...
	<div class="relative mx-auto max-w-7xl px-4 py-28 sm:px-6 sm:py-36 lg:px-8">
		<div class="mx-auto max-w-3xl text-center">
			<!-- Badge -->
			<div class="mb-8 inline-flex items-center gap-2 rounded-full border border-indigo-400/30 bg-indigo-500/10 px-4 py-1.5 text-sm font-medium text-indigo-300">
			...
			<h1 class="text-5xl font-extrabold tracking-tight sm:text-6xl lg:text-7xl">
				Create Professional
				<span class="mt-2 block bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
					Event Tickets
				</span>
			</h1>
			...
			<div class="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
				<a
					...
					class="group inline-flex items-center gap-2.5 rounded-xl bg-gradient-to-r from-indigo-600 to-indigo-500 px-8 py-4 text-sm font-semibold text-white shadow-xl shadow-indigo-600/25 transition-all hover:shadow-2xl hover:shadow-indigo-600/30 hover:brightness-110"
				>
		...
		<div class="grid gap-8 sm:grid-cols-3">
			{#each steps as step, i}
				<div class="relative text-center">
					{#if i < steps.length - 1}
						<div class="absolute top-8 left-[60%] hidden h-0.5 w-[80%] bg-gradient-to-r from-indigo-300 to-transparent sm:block"></div>
					{/if}
					<div class="relative mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500 to-indigo-600 text-2xl font-bold text-white shadow-lg shadow-indigo-500/25">
						{step.num}
					</div>
...
<section class="bg-gray-50 py-20">
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
		<div class="mb-12 text-center">
			<p class="text-sm font-semibold uppercase tracking-wider text-indigo-600">Blog</p>
			...
			<div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
				{#each posts as post}
					<article class="group overflow-hidden rounded-2xl bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
						...
						<div class="p-6">
							<time class="text-xs font-semibold uppercase tracking-wider text-indigo-600">
							...
							<h3 class="mt-3 text-lg font-bold text-gray-900 group-hover:text-indigo-600 transition-colors">{post.title}</h3>
...
<section class="bg-gradient-to-r from-indigo-600 to-purple-600 py-20">
	<div class="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
		...
		<a
			href="/ticket-generator"
			class="mt-8 inline-flex items-center gap-2 rounded-xl bg-white px-8 py-4 text-sm font-semibold text-indigo-600 shadow-xl transition-all hover:bg-gray-50 hover:shadow-2xl"
		>
			Get Started Free
